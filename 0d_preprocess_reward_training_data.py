...
def main(
    ...
    data_npz_dir: list[Path] = [Path("./data/processed_30fps_no_skating/"), Path("./data/processed_30fps_noised_no_skating/")],
    output_file: Path = Path("./data/egoalgo_no_skating_reward_dataset.hdf5"),
    output_list_file: Path = Path("./data/egoalgo_no_skating_reward_dataset_files.txt"),
    ...
    for dir in data_npz_dir:
        for path in list(dir.glob("**/*.npz")):
